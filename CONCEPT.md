...
- **Raft Implementation**: Building leader election, log replication, and safety mechanics from scratch—because real hustlers don't use off-the-shelf shortcuts.
